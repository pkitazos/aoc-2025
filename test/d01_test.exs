defmodule Aoc.D01Test do
  ...
  test "day 1 parse instruction" do
    ...
    assert Aoc.D01.parse_instruction("L19") == -19
  end

  test "day 1 turn dial" do
    assert Aoc.D01.apply_rotation(5, -10)
           |> then(&elem(&1, 0))
           |> then(&Aoc.D01.normalise/1) == 95

    assert Aoc.D01.apply_rotation(95, 5)
           |> then(&elem(&1, 0))
           |> then(&Aoc.D01.normalise/1) == 0
  end
